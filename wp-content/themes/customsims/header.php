...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" <?php if ( get_header_image() && is_front_page() ) : ?> style="background-image:url('<?php header_image(); ?>'); "<?php endif; ?> >
		<div class="site-branding <?php if (is_front_page() ) : ?> home-banner<?php endif; ?>">
			...
			$customsims_description = get_bloginfo( 'description', 'display' );
			if ( $customsims_description || is_customize_preview() ) :
				?>
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'customsims' ); ?></button>
			<?php
			wp_nav_menu( array(
